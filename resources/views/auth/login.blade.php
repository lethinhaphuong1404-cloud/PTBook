...
<body class="bg-black text-white min-h-screen relative overflow-y-auto overflow-x-hidden font-sans">
    ...
    <!-- Main -->
    <main class="relative z-20 flex items-center justify-center min-h-[85vh] px-4">
        ...
        <div class="w-full max-w-md bg-black/75 backdrop-blur-md rounded-2xl shadow-2xl p-8 md:p-10">
            ...
            <p class="text-gray-400 mb-8">Chào mừng bạn quay lại với PTApp</p>
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-6">
                ...
                <div class="flex justify-between items-center text-sm text-gray-400">
                    ...
                    <a href="/forgot-password" class="hover:underline hover:text-white">
                        Quên mật khẩu?
                    </a>
                </div>
            </form>
